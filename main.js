...
var random_number = Math.floor((Math.random() * quick_draw_data_set) + 1);
...
function classifyCanvas(canvas, gotResult){
    classifier.classify();
}
...
function gotResult(error, results){
    ...
    document.getElementById("yourSketch").innerHTML = "Your Sketch" + drawn_skecth;
    document.getElementById("confidence").innerHTML = "Confidence" + score + "%";
  }
}

function check_sketch(){
    timer_counter++;
    span = "Timer "+timer_counter;
